...
%
% Comentar este paquete para la versión impresa.
...
%
% Para marcar los terminos en ingles
...
%
% Definimos el nivel de detalle del Í­ndice: 
...
% Comandos para las plantillas de casos de uso (evitar duplicar código).
