...
A partir de este paradigma de desarrollo han ido apareciendo varios principios que nos ayudan al desarrollo y a mejorar la calidad del código y por tanto del programa. Principios como KISS (\en{Keep It Simple, Stupid}) nos recomienda que a la hora de desarrollar el código, éste debe ser simple y fácil de entender, generalmente los códigos simples funcionan mejor y son más fácilmente mantenibles que los códigos complejos y enrevesados con cientos de bucles y sentencias condicionales anidadas. Otro de estos principios, YAGNI (\en{You ain't gonna need it}) simplemente nos dice que no codifiquemos aquello que no vayamos a usar.
